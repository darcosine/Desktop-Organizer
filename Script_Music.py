...
desktop_path = os.path.expanduser("~/Music")
destination_path = os.path.expanduser("~/Music/Sorted Music")
...
for file in files:
    if file == "Sorted Music":  # Skip the destination directory
        continue
...
print("Music sorted successfully!")
