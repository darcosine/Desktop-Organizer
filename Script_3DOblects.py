...
desktop_path = os.path.expanduser("~/3D Objects")
destination_path = os.path.expanduser("~/3D Objects/Sorted Files")
...
for file in files:
    if file == "Sorted Files":  # Skip the destination directory
        continue
