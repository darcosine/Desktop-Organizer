...
destination_path = os.path.expanduser("~/Downloads/Sorted Downloads")
...
for file in files:
    if file == "Sorted Downloads":  # Skip the destination directory
        continue
...
print("Downloads sorted successfully!")
